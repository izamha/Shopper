...
fun FilterChip(
    ...
    val backgroundColor by animateColorAsState(
        if (selected) SnackyTheme.colors.brandSecondary else SnackyTheme.colors.uiBackground
    )
    ...
    val textColor by animateColorAsState(
        if (selected) Color.Black else SnackyTheme.colors.textSecondary
    )
        ...
        val backgroundPressed =
            if (pressed) {
                Modifier.offsetGradientBackground(
                    SnackyTheme.colors.interactiveSecondary,
                    200f,
                    0f
                )
            } else {
