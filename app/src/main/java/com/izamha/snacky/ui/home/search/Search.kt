package com.izamha.snacky.ui.home.search
...
import com.izamha.snacky.model.SearchCategoryCollection
import com.izamha.snacky.model.SearchRepo
import com.izamha.snacky.model.SearchSuggestionGroup
...
private fun SearchBar(
    ...
    SnackySurface(
        color = SnackyTheme.colors.uiFloated,
            ...
            Row(
                ...
                if (searchFocused) {
                    IconButton(onClick = onClearQuery) {
                        Icon(
                            ...
                            tint = SnackyTheme.colors.iconPrimary,
                ...
                if (searching) {
                    CircularProgressIndicator(
                        color = SnackyTheme.colors.iconPrimary,
                        modifier = Modifier
...
private fun SearchHint() {
    Row(
        ...
        Icon(
            ...
            tint = SnackyTheme.colors.textHelp,
            contentDescription = stringResource(R.string.label_search)
        )
        Spacer(Modifier.width(8.dp))
        Text(
            text = stringResource(R.string.search_snacky),
