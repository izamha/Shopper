package com.izamha.snacky.ui.theme
...
private val LightColorPalette = SnackyColors(
    brand = Shadow5,
...
private val DarkColorPalette = SnackyColors(
    brand = Shadow1,
...
object SnackyTheme {
    val colors: SnackyColors
        @Composable
        get() = LocalJetsnackColors.current
}

/**
 * Snacky custom Color Palette
 */
@Stable
class SnackyColors(
    ...
    fun copy(): SnackyColors = SnackyColors(
...
private val LocalJetsnackColors = staticCompositionLocalOf<SnackyColors> {
    error("No JetsnackColorPalette provided")
}

/**
 * A Material [Colors] implementation which sets all colors to [debugColor] to discourage usage of
 * [MaterialTheme.colors] in preference to [SnackyTheme.colors].
 */
fun debugColors(
    darkTheme: Boolean,
